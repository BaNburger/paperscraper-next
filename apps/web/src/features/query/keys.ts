...
export const queryKeys = {
  ...
  objectNote: (objectId: string) => ['workspace', 'object-note', objectId] as const,
  ...
  workspaceSavedViews: () => ['workspace', 'saved-views'] as const,
  workspaceFeedPreferences: () => ['workspace', 'feed-preferences'] as const,
};
