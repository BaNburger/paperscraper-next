...
2. Integration: feed state persistence and batch mutation flows.
3. E2E: keyboard-only triage from feed to pipeline action.
4. Performance: interaction and feed query regression checks.
5. Security: mutation authorization and error handling smoke tests.
